...
@section('content')
    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            <th>Order Date</th>
                            <th>
                                {{ \Carbon\Carbon::parse($order->created_at)->timezone('Asia/Bangkok') }}
                            </th>
                            <th>Delivered Date</th>
                            <th>
                                {{ $order->delivered_date ? \Carbon\Carbon::parse($order->delivered_date)->timezone('Asia/Bangkok') : $order->delivered_date }}
                            </th>
                            <th>Cancelled Date</th>
                            <th>
                                {{ $order->cancelled_date ? \Carbon\Carbon::parse($order->cancelled_date)->timezone('Asia/Bangkok') : $order->cancelled_date }}
                            </th>
                        </tr>
                        <tr>
                            <th>Order Status</th>
            ...
            @if ($transaction->mode == 'cod' && $order->status == 'ordered')
                <div class="wg-box mt-5">
