                ...
                <div class="col-lg-5">
                    ...
                    <div class="product-single__price">
                        <span class="current-price">
                            @if ($product->regular_price != $product->sale_price && $product->sale_price < $product->regular_price)
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <div class="product-card__price d-flex">
                                        <span class="money price">
                                            @if ($rproduct->regular_price != $rproduct->sale_price && $rproduct->sale_price < $rproduct->regular_price)
