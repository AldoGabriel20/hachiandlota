  ...
  <main>
    ...
    <div class="row">
      ...
      "pagination": false
        ...
        <div class="swiper-wrapper">
          ...
          <div class="pc__img-wrapper">
            <a href="details.html">
            <img loading="lazy" src="{{ asset('assets/images/home/demo3/manor.jpeg') }}" width="258"
              height="313" alt="Manor" class="pc__img">
            <img loading="lazy" src="{{ asset('assets/images/home/demo3/manor.jpeg') }}" width="258"
              height="313" alt="Manor" class="pc__img pc__img-second">
            </a>
          </div>
          ...
          <div class="pc__img-wrapper">
            <a href="details.html">
            <img loading="lazy" src="{{ asset('assets/images/home/demo3/solace.jpeg') }}" width="258"
              height="313" alt="Solace" class="pc__img">
            <img loading="lazy" src="{{ asset('assets/images/home/demo3/solace.jpeg') }}" width="258"
              height="313" alt="Solace" class="pc__img pc__img-second">
            </a>
          </div>
          ...
          <div class="pc__img-wrapper">
            <a href="details.html">
            <img loading="lazy" src="{{ asset('assets/images/home/demo3/serenity.jpeg') }}" width="258"
              height="313" alt="Serenity" class="pc__img">
            <img loading="lazy" src="{{ asset('assets/images/home/demo3/serenity.jpeg') }}" width="258"
              height="313" alt="Serenity" class="pc__img pc__img-second">
            </a>
          </div>
          ...
          <div class="pc__img-wrapper">
            <a href="details.html">
            <img loading="lazy" src="{{ asset('assets/images/home/demo3/springdale.jpeg') }}" width="258"
              height="313" alt="Springdale" class="pc__img">
            <img loading="lazy" src="{{ asset('assets/images/home/demo3/springdale.jpeg') }}" width="258"
              height="313" alt="Springdale" class="pc__img pc__img-second">
            </a>
          </div>
          ...
          <div class="pc__img-wrapper">
            <a href="details.html">
            <img loading="lazy" src="{{ asset('assets/images/home/demo3/countryside.jpeg') }}" width="258"
              height="313" alt="Countryside" class="pc__img">
            <img loading="lazy" src="{{ asset('assets/images/home/demo3/countryside.jpeg') }}" width="258"
              height="313" alt="Countryside" class="pc__img pc__img-second">
            </a>
          </div>
    ...
    <div class="row">
      ...
      <div class="category-banner__item border-radius-10 mb-5">
        <img loading="lazy" class="h-auto" src="{{ asset('assets/images/home/demo3/countryside.jpeg') }}" width="690"
        height="665" alt="" />
      ...
      <div class="col-md-6">
      <div class="category-banner__item border-radius-10 mb-5">
        <img loading="lazy" class="h-auto" src="{{ asset('assets/images/home/demo3/sada.jpeg') }}" width="690"
        height="665" alt="" />
        <div class="category-banner__item-mark">
