  ...
  <main>
    ...
    <div class="row">
      ...
      "pagination": false
        ...
        <span class="money price text-secondary">
          @if ($sproduct->regular_price != $sproduct->sale_price && $sproduct->sale_price < $sproduct->regular_price)
    ...
    <div class="row">
      ...
      <div class="product-card__price d-flex align-items-center">
        <span class="money price text-secondary">
        @if ($fproduct->regular_price != $fproduct->sale_price && $fproduct->sale_price < $fproduct->regular_price)
