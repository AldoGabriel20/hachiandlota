        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
              <img loading="lazy" src="{{ asset('assets/images/home/demo3/slideshow-hampers1.jpg') }}" width="542" height="733"
                alt="Woman Fashion 1"
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                New Arrivals</h6>
              <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Eid Mubarak</h2>
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">Hampers</h2>
              <a href="#"
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="details.html">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/nora.jpeg') }}" width="258" height="313"
                          alt="Nora" class="pc__img">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/nora.jpeg') }}" width="258" height="313"
                          alt="Nora" class="pc__img pc__img-second">
                      </a>
                    </div>

                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="details.html">Nora</a></h6>
                      <div class="product-card__price d-flex">
                        <span class="money price text-secondary">Rp. 100.000</span>
                      </div>
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="details.html">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/sada.jpeg') }}" width="258" height="313"
                          alt="Sada" class="pc__img">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/sada.jpeg') }}" width="258" height="313"
                          alt="Sada" class="pc__img pc__img-second">
                      </a>
                    </div>

                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="details.html">Sada</a></h6>
                      <div class="product-card__price d-flex">
                        <span class="money price text-secondary">Rp. 150.000</span>
                      </div>
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="details.html">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/manor.jpeg') }}" width="258" height="313"
                          alt="Manor" class="pc__img">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/manor.jpeg') }}" width="258" height="313"
                          alt="Manor" class="pc__img pc__img-second">
                      </a>
                    </div>

                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="details.html">Manor</a></h6>
                      <div class="product-card__price d-flex">
                        <span class="money price text-secondary">Rp. 150.000</span>
                      </div>
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="details.html">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/solace.jpeg') }}" width="258" height="313"
                          alt="Solace" class="pc__img">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/solace.jpeg') }}" width="258" height="313"
                          alt="Solace" class="pc__img pc__img-second">
                      </a>
                    </div>

                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="details.html">Solace</a></h6>
                      <div class="product-card__price d-flex align-items-center">
                        <span class="money price-old">Rp. 215.000</span>
                        <span class="money price text-secondary">Rp. 205.000</span>
                      </div>
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="details.html">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/serenity.jpeg') }}" width="258" height="313"
                          alt="Serenity" class="pc__img">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/serenity.jpeg') }}" width="258" height="313"
                          alt="Serenity" class="pc__img pc__img-second">
                      </a>
                    </div>

                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="details.html">Serenity</a></h6>
                      <div class="product-card__price d-flex">
                        <span class="money price text-secondary">Rp. 350.000</span>
                      </div>
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="details.html">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/springdale.jpeg') }}" width="258" height="313"
                          alt="Springdale" class="pc__img">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/springdale.jpeg') }}" width="258" height="313"
                          alt="Springdale" class="pc__img pc__img-second">
                      </a>
                    </div>

                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="details.html">Springdale</a></h6>
                      <div class="product-card__price d-flex">
                        <span class="money price text-secondary">Rp. 540.000</span>
                      </div>
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="details.html">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/countryside.jpeg') }}" width="258" height="313"
                          alt="Countryside" class="pc__img">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/countryside.jpeg') }}" width="258" height="313"
                          alt="Countryside" class="pc__img pc__img-second">
                      </a>
                    </div>

                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="details.html">Countryside</a></h6>
                      <div class="product-card__price d-flex">
                        <span class="money price text-secondary">Rp. 750.000</span>
                      </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="category-banner__item border-radius-10 mb-5">
              <img loading="lazy" class="h-auto" src="{{ asset('assets/images/home/demo3/countryside.jpeg') }}" width="690" height="665"
                alt="" />
              <div class="category-banner__item-mark">
                Starting at Rp. 800.000
              </div>
              <div class="category-banner__item-content">
                <h3 class="mb-0">Countryside</h3>
          ...
          <div class="col-md-6">
            <div class="category-banner__item border-radius-10 mb-5">
              <img loading="lazy" class="h-auto" src="{{ asset('assets/images/home/demo3/sada.jpeg') }}" width="690" height="665"
                alt="" />
              <div class="category-banner__item-mark">
                Starting at Rp. 150.000
              </div>
              <div class="category-banner__item-content">
                <h3 class="mb-0">Sada</h3>
                <a href="#" class="btn-link default-underline text-uppercase fw-medium">Shop Now</a>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-6 col-md-4 col-lg-4">
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <a href="details.html">
                  <img loading="lazy" src="{{ asset('assets/images/home/demo3/kensington.jpeg') }}" width="330" height="400"
                    alt="Cropped Faux leather Jacket" class="pc__img">
                </a>
              </div>

              <div class="pc__info position-relative">
                <h6 class="pc__title"><a href="details.html">Kensington</a></h6>
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price text-secondary">Rp. 600.000</span>
                </div>
          ...
          <div class="col-6 col-md-4 col-lg-4">
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <a href="details.html">
                  <img loading="lazy" src="{{ asset('assets/images/home/demo3/hudson.jpeg') }}" width="330" height="400"
                    alt="Cropped Faux leather Jacket" class="pc__img">
                </a>
              </div>

              <div class="pc__info position-relative">
                <h6 class="pc__title"><a href="details.html">Hudson</a></h6>
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price text-secondary">Rp. 350.000</span>
                </div>
          ...
          <div class="col-6 col-md-4 col-lg-4">
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <a href="details.html">
                  <img loading="lazy" src="{{ asset('assets/images/home/demo3/jade.jpeg') }}" width="330" height="400"
                    alt="Cropped Faux leather Jacket" class="pc__img">
                </a>
              ...
              <div class="pc__info position-relative">
                <h6 class="pc__title"><a href="details.html">Jade</a></h6>
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price text-secondary">Rp. 100.000</span>
                </div>
          ...
          <div class="col-6 col-md-4 col-lg-4">
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <a href="details.html">
                  <img loading="lazy" src="{{ asset('assets/images/home/demo3/scarlet.jpeg') }}" width="330" height="400"
                    alt="Cropped Faux leather Jacket" class="pc__img">
                </a>
              ...
              <div class="pc__info position-relative">
                <h6 class="pc__title">Scarlet</h6>
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price-old">Rp. 250.000</span>
                  <span class="money price text-secondary">Rp. 215.000</span>
                </div>
          ...
          <div class="col-6 col-md-4 col-lg-4">
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <a href="details.html">
                  <img loading="lazy" src="{{ asset('assets/images/home/demo3/royal.jpeg') }}" width="330" height="400"
                    alt="Cropped Faux leather Jacket" class="pc__img">
                </a>
              </div>

              <div class="pc__info position-relative">
                <h6 class="pc__title"><a href="details.html">Royal</a></h6>
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price text-secondary">Rp. 550.000</span>
                </div>
